    ...
    <>
        <div className={styles.contactForm}>
            ...
            <div className={styles.contactForm__fields}>
                <h2>Nombre*</h2>
                <NameField placeHolder="Digita tu nombre" value={nameText} change={setNameText}/>
                <h2>Ciudad*</h2>
                <NameField placeHolder="Digita tu ciudad" value={cityText} change={setCityText} />
            </div>
            <div className={styles.buttons}>
                {/* <button>Volver</button>
                <button>Enviar</button> */}
                <Button text="VOLVER" route="/detail" />
                <a href={ref} target="_blank" rel="noreferrer"><button>ENVIAR</button></a>
            </div>
</div>
